        ...
        <a-col :span="24">
          ...
          <div style="line-height:32px;">
            ...
            <p>
              ...
              <span
                style="font-size:18px;color:red;padding-right:12px;"
              >{{number_chinese(item.total)}}</span>
            </p>
          </div>
        ...
        <a-col :span="24" style="margin-top:20px;">
          <table class="table_style">
            <tr style="background-color:#f1f1f1;color:#333333 ;font-weight:normal;">
              ...
              <th style="width:8%">物资大类及标准</th>
              <th style="width:10%">型(牌)号、规格</th>
          ...
          <a-col :span="24" style="padding-top:20px;">
            <a-col :span="6">
              <div style="text-align:right;width:120px;">部门主管：</div>
            </a-col>
            <a-col :span="6">
              <div style="text-align:right;width:120px;">库管员：</div>
            </a-col>
            <a-col :span="6">
              <div style="text-align:right;width:120px;">项目审核：</div>
            </a-col>
            <a-col :span="6">
              <div style="text-align:right;width:120px;">项目经办：</div>
            </a-col>
          </a-col>
        </a-col>
